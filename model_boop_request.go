...
// checks if the BoopRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BoopRequest{}
...
func (o BoopRequest) ToMap() (map[string]interface{}, error) {
...
type NullableBoopRequest struct {
	value *BoopRequest
	isSet bool
}

func (v NullableBoopRequest) Get() *BoopRequest {
	return v.value
}

func (v *NullableBoopRequest) Set(val *BoopRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBoopRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBoopRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBoopRequest(val *BoopRequest) *NullableBoopRequest {
	return &NullableBoopRequest{value: val, isSet: true}
}

func (v NullableBoopRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBoopRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
