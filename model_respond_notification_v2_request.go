...
// checks if the RespondNotificationV2Request type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RespondNotificationV2Request{}

// RespondNotificationV2Request struct for RespondNotificationV2Request
type RespondNotificationV2Request struct {
	ResponseData *string `json:"responseData,omitempty"`
	ResponseType string `json:"responseType"`
}

type _RespondNotificationV2Request RespondNotificationV2Request
...
func NewRespondNotificationV2Request(responseType string) *RespondNotificationV2Request {
	this := RespondNotificationV2Request{}
...
func (o RespondNotificationV2Request) MarshalJSON() ([]byte, error) {
...
func (o RespondNotificationV2Request) ToMap() (map[string]interface{}, error) {
...
func (o *RespondNotificationV2Request) UnmarshalJSON(data []byte) (err error) {
	...
	*o = RespondNotificationV2Request(varRespondNotificationV2Request)

	return err
}

type NullableRespondNotificationV2Request struct {
	value *RespondNotificationV2Request
	isSet bool
}

func (v NullableRespondNotificationV2Request) Get() *RespondNotificationV2Request {
	return v.value
}

func (v *NullableRespondNotificationV2Request) Set(val *RespondNotificationV2Request) {
	v.value = val
	v.isSet = true
}

func (v NullableRespondNotificationV2Request) IsSet() bool {
	return v.isSet
}

func (v *NullableRespondNotificationV2Request) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRespondNotificationV2Request(val *RespondNotificationV2Request) *NullableRespondNotificationV2Request {
	return &NullableRespondNotificationV2Request{value: val, isSet: true}
}

func (v NullableRespondNotificationV2Request) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRespondNotificationV2Request) UnmarshalJSON(src []byte) error {
	v.isSet = true
