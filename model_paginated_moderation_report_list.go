...
// checks if the PaginatedModerationReportList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedModerationReportList{}

// PaginatedModerationReportList struct for PaginatedModerationReportList
type PaginatedModerationReportList struct {
	// Whether there are more results after this page.
	HasNext *bool `json:"hasNext,omitempty"`
	// The list of moderation reports.
	Results []ModerationReport `json:"results,omitempty"`
...
func NewPaginatedModerationReportList() *PaginatedModerationReportList {
	this := PaginatedModerationReportList{}
	return &this
}
...
// SetResults gets a reference to the given []ModerationReport and assigns it to the Results field.
...
func (o PaginatedModerationReportList) MarshalJSON() ([]byte, error) {
...
func (o PaginatedModerationReportList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedModerationReportList struct {
	value *PaginatedModerationReportList
	isSet bool
}

func (v NullablePaginatedModerationReportList) Get() *PaginatedModerationReportList {
	return v.value
}

func (v *NullablePaginatedModerationReportList) Set(val *PaginatedModerationReportList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedModerationReportList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedModerationReportList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedModerationReportList(val *PaginatedModerationReportList) *NullablePaginatedModerationReportList {
	return &NullablePaginatedModerationReportList{value: val, isSet: true}
}

func (v NullablePaginatedModerationReportList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedModerationReportList) UnmarshalJSON(src []byte) error {
	v.isSet = true
