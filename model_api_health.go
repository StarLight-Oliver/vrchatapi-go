...
func NewAPIHealth(buildVersionTag string, ok bool, serverName string) *APIHealth {
	this := APIHealth{}
...
func (o *APIHealth) UnmarshalJSON(data []byte) (err error) {
