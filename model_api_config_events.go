...
type APIConfigEvents struct {
	...
	// Unknown
	UseDirectPlayerSerialization bool `json:"useDirectPlayerSerialization"`
	// Unknown
	ViewSegmentLength int32 `json:"viewSegmentLength"`
}

type _APIConfigEvents APIConfigEvents

// NewAPIConfigEvents instantiates a new APIConfigEvents object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAPIConfigEvents(distanceClose int32, distanceFactor int32, distanceFar int32, groupDistance int32, maximumBunchSize int32, notVisibleFactor int32, playerOrderBucketSize int32, playerOrderFactor int32, slowUpdateFactorThreshold int32, useDirectPlayerSerialization bool, viewSegmentLength int32) *APIConfigEvents {
...
// GetUseDirectPlayerSerialization returns the UseDirectPlayerSerialization field value
func (o *APIConfigEvents) GetUseDirectPlayerSerialization() bool {
	if o == nil {
		var ret bool
		return ret
	}

	return o.UseDirectPlayerSerialization
}

// GetUseDirectPlayerSerializationOk returns a tuple with the UseDirectPlayerSerialization field value
// and a boolean to check if the value has been set.
func (o *APIConfigEvents) GetUseDirectPlayerSerializationOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.UseDirectPlayerSerialization, true
}

// SetUseDirectPlayerSerialization sets field value
func (o *APIConfigEvents) SetUseDirectPlayerSerialization(v bool) {
	o.UseDirectPlayerSerialization = v
}
...
func (o APIConfigEvents) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["useDirectPlayerSerialization"] = o.UseDirectPlayerSerialization
	toSerialize["viewSegmentLength"] = o.ViewSegmentLength
	return toSerialize, nil
}

func (o *APIConfigEvents) UnmarshalJSON(data []byte) (err error) {
	...
	varAPIConfigEvents := _APIConfigEvents{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAPIConfigEvents)

	if err != nil {
		return err
	}

	*o = APIConfigEvents(varAPIConfigEvents)
