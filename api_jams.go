...
func (r ApiGetJamRequest) Execute() (*Jam, *http.Response, error) {
	return r.ApiService.GetJamExecute(r)
}

/*
GetJam Show jam information
...
func (r ApiGetJamSubmissionsRequest) Execute() ([]Submission, *http.Response, error) {
	return r.ApiService.GetJamSubmissionsExecute(r)
}

/*
GetJamSubmissions Show jam submissions
...
func (r ApiGetJamsRequest) Type_(type_ string) ApiGetJamsRequest {
	r.type_ = &type_
	return r
}

func (r ApiGetJamsRequest) Execute() ([]Jam, *http.Response, error) {
	return r.ApiService.GetJamsExecute(r)
}

/*
GetJams Show jams list
...
func (a *JamsAPIService) GetJamsExecute(r ApiGetJamsRequest) ([]Jam, *http.Response, error) {
	...
	localVarPath := localBasePath + "/jams"
