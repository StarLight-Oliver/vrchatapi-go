...
type _LimitedWorld LimitedWorld
...
func (o *LimitedWorld) SetPreviewYoutubeIdNil() {
...
func (o *LimitedWorld) UnmarshalJSON(data []byte) (err error) {
	...
	*o = LimitedWorld(varLimitedWorld)
