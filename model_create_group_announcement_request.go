...
type _CreateGroupAnnouncementRequest CreateGroupAnnouncementRequest
...
func (o *CreateGroupAnnouncementRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CreateGroupAnnouncementRequest(varCreateGroupAnnouncementRequest)
