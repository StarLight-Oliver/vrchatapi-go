...
func (o *InstanceShortNameResponse) UnsetShortName() {
	o.ShortName.Unset()
}
...
func (o *InstanceShortNameResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = InstanceShortNameResponse(varInstanceShortNameResponse)
