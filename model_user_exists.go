...
// GetNameOk returns the NameOk field value if set, zero value otherwise.
func (o *UserExists) GetNameOk() bool {
	if o == nil || IsNil(o.NameOk) {
		var ret bool
		return ret
	}
	return *o.NameOk
...
// GetNameOkOk returns a tuple with the NameOk field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserExists) GetNameOkOk() (*bool, bool) {
	if o == nil || IsNil(o.NameOk) {
		return nil, false
	}
	return o.NameOk, true
}
...
// SetNameOk gets a reference to the given bool and assigns it to the NameOk field.
...
func (o UserExists) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NameOk) {
		toSerialize["nameOk"] = o.NameOk
	}
	toSerialize["userExists"] = o.UserExists
	return toSerialize, nil
}

func (o *UserExists) UnmarshalJSON(data []byte) (err error) {
