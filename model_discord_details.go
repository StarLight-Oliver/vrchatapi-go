...
func (o DiscordDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !IsNil(o.GlobalName) {
		toSerialize["global_name"] = o.GlobalName
	}
	if !IsNil(o.Id) {
		toSerialize["id"] = o.Id
	}
...
type NullableDiscordDetails struct {
	value *DiscordDetails
	isSet bool
}

func (v NullableDiscordDetails) Get() *DiscordDetails {
	return v.value
}

func (v *NullableDiscordDetails) Set(val *DiscordDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscordDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscordDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscordDetails(val *DiscordDetails) *NullableDiscordDetails {
	return &NullableDiscordDetails{value: val, isSet: true}
}

func (v NullableDiscordDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscordDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
