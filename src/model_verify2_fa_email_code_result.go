...
type _Verify2FAEmailCodeResult Verify2FAEmailCodeResult
...
func (o *Verify2FAEmailCodeResult) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Verify2FAEmailCodeResult(varVerify2FAEmailCodeResult)
