...
// checks if the UpdateInventoryItemRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateInventoryItemRequest{}
...
func NewUpdateInventoryItemRequest() *UpdateInventoryItemRequest {
	this := UpdateInventoryItemRequest{}
	return &this
}
...
// SetUserAttributes gets a reference to the given InventoryUserAttributes and assigns it to the UserAttributes field.
...
func (o UpdateInventoryItemRequest) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateInventoryItemRequest struct {
	value *UpdateInventoryItemRequest
	isSet bool
}

func (v NullableUpdateInventoryItemRequest) Get() *UpdateInventoryItemRequest {
	return v.value
}

func (v *NullableUpdateInventoryItemRequest) Set(val *UpdateInventoryItemRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateInventoryItemRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateInventoryItemRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateInventoryItemRequest(val *UpdateInventoryItemRequest) *NullableUpdateInventoryItemRequest {
	return &NullableUpdateInventoryItemRequest{value: val, isSet: true}
}

func (v NullableUpdateInventoryItemRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateInventoryItemRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
