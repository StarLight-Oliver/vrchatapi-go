...
func (r ApiBoopRequest) BoopRequest(boopRequest BoopRequest) ApiBoopRequest {
	r.boopRequest = &boopRequest
	return r
}

func (r ApiBoopRequest) Execute() (*Success, *http.Response, error) {
	return r.ApiService.BoopExecute(r)
}
...
func (a *FriendsAPIService) BoopExecute(r ApiBoopRequest) (*Success, *http.Response, error) {
	...
	if r.boopRequest == nil {
		return localVarReturnValue, nil, reportError("boopRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.boopRequest
...
func (r ApiGetFriendsRequest) Execute() ([]LimitedUserFriend, *http.Response, error) {
