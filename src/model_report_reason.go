...
// checks if the ReportReason type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportReason{}
...
type _ReportReason ReportReason
...
func (o ReportReason) MarshalJSON() ([]byte, error) {
...
func (o ReportReason) ToMap() (map[string]interface{}, error) {
...
func (o *ReportReason) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ReportReason(varReportReason)

	return err
}

type NullableReportReason struct {
	value *ReportReason
	isSet bool
}

func (v NullableReportReason) Get() *ReportReason {
	return v.value
}

func (v *NullableReportReason) Set(val *ReportReason) {
	v.value = val
	v.isSet = true
}

func (v NullableReportReason) IsSet() bool {
	return v.isSet
}

func (v *NullableReportReason) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportReason(val *ReportReason) *NullableReportReason {
	return &NullableReportReason{value: val, isSet: true}
}

func (v NullableReportReason) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportReason) UnmarshalJSON(src []byte) error {
	v.isSet = true
