...
func NewPropUnityPackageWithDefaults() *PropUnityPackage {
	this := PropUnityPackage{}
	var unityVersion string = "2022.3.22f1"
	this.UnityVersion = unityVersion
	return &this
}
...
// GetPropSignature returns the PropSignature field value
...
// GetPropSignatureOk returns a tuple with the PropSignature field value
// and a boolean to check if the value has been set.
...
// SetPropSignature sets field value
...
func (o PropUnityPackage) ToMap() (map[string]interface{}, error) {
...
func (o *PropUnityPackage) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PropUnityPackage(varPropUnityPackage)

	return err
}

type NullablePropUnityPackage struct {
	value *PropUnityPackage
	isSet bool
}

func (v NullablePropUnityPackage) Get() *PropUnityPackage {
	return v.value
}

func (v *NullablePropUnityPackage) Set(val *PropUnityPackage) {
	v.value = val
	v.isSet = true
}

func (v NullablePropUnityPackage) IsSet() bool {
	return v.isSet
}

func (v *NullablePropUnityPackage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePropUnityPackage(val *PropUnityPackage) *NullablePropUnityPackage {
	return &NullablePropUnityPackage{value: val, isSet: true}
}

func (v NullablePropUnityPackage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePropUnityPackage) UnmarshalJSON(src []byte) error {
	v.isSet = true
