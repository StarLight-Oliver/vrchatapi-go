...
// checks if the GroupRoleTemplateValues type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupRoleTemplateValues{}

// GroupRoleTemplateValues struct for GroupRoleTemplateValues
type GroupRoleTemplateValues struct {
	BasePermissions []GroupPermissions `json:"basePermissions"`
	Description string `json:"description"`
	Name string `json:"name"`
	Roles GroupRoleTemplateValuesRoles `json:"roles"`
}

type _GroupRoleTemplateValues GroupRoleTemplateValues
...
// GetBasePermissions returns the BasePermissions field value
...
// GetBasePermissionsOk returns a tuple with the BasePermissions field value
...
// SetBasePermissions sets field value
...
func (o *GroupRoleTemplateValues) GetRoles() GroupRoleTemplateValuesRoles {
	if o == nil {
		var ret GroupRoleTemplateValuesRoles
		return ret
	}
...
func (o GroupRoleTemplateValues) MarshalJSON() ([]byte, error) {
...
func (o GroupRoleTemplateValues) ToMap() (map[string]interface{}, error) {
...
func (o *GroupRoleTemplateValues) UnmarshalJSON(data []byte) (err error) {
	...
	*o = GroupRoleTemplateValues(varGroupRoleTemplateValues)

	return err
}

type NullableGroupRoleTemplateValues struct {
	value *GroupRoleTemplateValues
	isSet bool
}

func (v NullableGroupRoleTemplateValues) Get() *GroupRoleTemplateValues {
	return v.value
}

func (v *NullableGroupRoleTemplateValues) Set(val *GroupRoleTemplateValues) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupRoleTemplateValues) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupRoleTemplateValues) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupRoleTemplateValues(val *GroupRoleTemplateValues) *NullableGroupRoleTemplateValues {
	return &NullableGroupRoleTemplateValues{value: val, isSet: true}
}

func (v NullableGroupRoleTemplateValues) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupRoleTemplateValues) UnmarshalJSON(src []byte) error {
	v.isSet = true
