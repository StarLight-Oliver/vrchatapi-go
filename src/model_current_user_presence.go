...
// GetDebugflag returns the Debugflag field value if set, zero value otherwise.
func (o *CurrentUserPresence) GetDebugflag() string {
	if o == nil || IsNil(o.Debugflag) {
		var ret string
		return ret
	}
	return *o.Debugflag
...
// GetDebugflagOk returns a tuple with the Debugflag field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CurrentUserPresence) GetDebugflagOk() (*string, bool) {
	if o == nil || IsNil(o.Debugflag) {
		return nil, false
	}
	return o.Debugflag, true
}
...
// SetDebugflag gets a reference to the given string and assigns it to the Debugflag field.
...
// GetUserIcon returns the UserIcon field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CurrentUserPresence) GetUserIcon() string {
	if o == nil || IsNil(o.UserIcon.Get()) {
		var ret string
		return ret
	}
	return *o.UserIcon.Get()
}
...
// SetUserIcon gets a reference to the given NullableString and assigns it to the UserIcon field.
...
func (o CurrentUserPresence) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.Debugflag) {
		toSerialize["debugflag"] = o.Debugflag
	}
	...
	if o.UserIcon.IsSet() {
		toSerialize["userIcon"] = o.UserIcon.Get()
	}
	if !IsNil(o.World) {
