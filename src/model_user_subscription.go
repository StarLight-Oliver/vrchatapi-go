...
func NewUserSubscription(active bool, amount float32, createdAt time.Time, description string, expires time.Time, id string, isBulkGift bool, isGift bool, licenseGroups []string, period SubscriptionPeriod, status TransactionStatus, store string, tier int32, transactionId string, updatedAt time.Time) *UserSubscription {
...
// GetIsBulkGift returns the IsBulkGift field value
func (o *UserSubscription) GetIsBulkGift() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// GetIsBulkGiftOk returns a tuple with the IsBulkGift field value
// and a boolean to check if the value has been set.
func (o *UserSubscription) GetIsBulkGiftOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.IsBulkGift, true
}

// SetIsBulkGift sets field value
func (o *UserSubscription) SetIsBulkGift(v bool) {
	o.IsBulkGift = v
}
...
func (o *UserSubscription) GetStarts() string {
...
// and a boolean to check if the value has been set.
func (o *UserSubscription) GetStartsOk() (*string, bool) {
	if o == nil || IsNil(o.Starts) {
		return nil, false
	}
...
func (o *UserSubscription) HasStarts() bool {
	if o != nil && !IsNil(o.Starts) {
		return true
	}
...
// SetStarts gets a reference to the given string and assigns it to the Starts field.
func (o *UserSubscription) SetStarts(v string) {
	o.Starts = &v
}
...
func (o *UserSubscription) GetTier() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *UserSubscription) GetTierOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Tier, true
...
func (o *UserSubscription) SetTier(v int32) {
	o.Tier = v
}
...
func (o UserSubscription) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["id"] = o.Id
	toSerialize["isBulkGift"] = o.IsBulkGift
