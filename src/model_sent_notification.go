...
type SentNotification struct {
	...
	Details   SentNotificationDetails `json:"details"`
	Id        string                  `json:"id"`
	//
...
type _SentNotification SentNotification
...
func (o *SentNotification) GetDetails() SentNotificationDetails {
	if o == nil {
		var ret SentNotificationDetails
		return ret
	}
...
func (o *SentNotification) UnmarshalJSON(data []byte) (err error) {
	...
	varSentNotification := _SentNotification{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSentNotification)

	if err != nil {
		return err
	}

	*o = SentNotification(varSentNotification)
