...
func (o *InstancePlatforms) GetIos() int32 {
...
// and a boolean to check if the value has been set.
func (o *InstancePlatforms) GetIosOk() (*int32, bool) {
	if o == nil || IsNil(o.Ios) {
		return nil, false
	}
	return o.Ios, true
...
func (o *InstancePlatforms) HasIos() bool {
	if o != nil && !IsNil(o.Ios) {
		return true
	}
...
// SetIos gets a reference to the given int32 and assigns it to the Ios field.
func (o *InstancePlatforms) SetIos(v int32) {
	o.Ios = &v
}
...
func (o *InstancePlatforms) UnmarshalJSON(data []byte) (err error) {
	...
	*o = InstancePlatforms(varInstancePlatforms)
