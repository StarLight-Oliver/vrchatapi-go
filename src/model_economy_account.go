...
var _ MappedNullable = &EconomyAccount{}
...
type _EconomyAccount EconomyAccount
...
// GetAccountActivatedOn returns the AccountActivatedOn field value
// If the value is explicit nil, the zero value for time.Time will be returned
func (o *EconomyAccount) GetAccountActivatedOn() time.Time {
	if o == nil || o.AccountActivatedOn.Get() == nil {
		var ret time.Time
		return ret
	}

	return *o.AccountActivatedOn.Get()
}

// GetAccountActivatedOnOk returns a tuple with the AccountActivatedOn field value
...
func (o *EconomyAccount) GetAccountActivatedOnOk() (*time.Time, bool) {
	...
	return o.AccountActivatedOn.Get(), o.AccountActivatedOn.IsSet()
}

// SetAccountActivatedOn sets field value
func (o *EconomyAccount) SetAccountActivatedOn(v time.Time) {
	o.AccountActivatedOn.Set(&v)
}
...
// GetCanSpend returns the CanSpend field value
...
// GetCanSpendOk returns a tuple with the CanSpend field value
// and a boolean to check if the value has been set.
func (o *EconomyAccount) GetCanSpendOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.CanSpend, true
}

// SetCanSpend sets field value
...
func (o EconomyAccount) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["accountActivatedOn"] = o.AccountActivatedOn.Get()
	toSerialize["accountId"] = o.AccountId.Get()
	toSerialize["blocked"] = o.Blocked
	toSerialize["canSpend"] = o.CanSpend
	toSerialize["source"] = o.Source
	toSerialize["userId"] = o.UserId
	return toSerialize, nil
}

func (o *EconomyAccount) UnmarshalJSON(data []byte) (err error) {
	...
	*o = EconomyAccount(varEconomyAccount)

	return err
}

type NullableEconomyAccount struct {
	value *EconomyAccount
	isSet bool
}

func (v NullableEconomyAccount) Get() *EconomyAccount {
	return v.value
}

func (v *NullableEconomyAccount) Set(val *EconomyAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableEconomyAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableEconomyAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEconomyAccount(val *EconomyAccount) *NullableEconomyAccount {
	return &NullableEconomyAccount{value: val, isSet: true}
}

func (v NullableEconomyAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEconomyAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
