...
func (o *WorldPublishStatus) GetCanPublish() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
func (o *WorldPublishStatus) GetCanPublishOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WorldPublishStatus) SetCanPublish(v bool) {
	o.CanPublish = v
}
...
func (o *WorldPublishStatus) UnmarshalJSON(data []byte) (err error) {
	...
	*o = WorldPublishStatus(varWorldPublishStatus)
