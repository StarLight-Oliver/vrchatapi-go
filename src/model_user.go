...
type User struct {
	...
	LastMobile NullableString `json:"last_mobile,omitempty"`
...
// SetLastMobile gets a reference to the given NullableString and assigns it to the LastMobile field.
func (o *User) SetLastMobile(v string) {
	o.LastMobile.Set(&v)
}

// SetLastMobileNil sets the value for LastMobile to be an explicit nil
func (o *User) SetLastMobileNil() {
