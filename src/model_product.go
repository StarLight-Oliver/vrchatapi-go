...
type Product struct {
	...
	ParentListings       []string     `json:"parentListings"`
...
func NewProduct(description string, displayName string, id string, imageId string, parentListings []string, productType ProductType, sellerDisplayName string, sellerId string, tags []string) *Product {
	...
	var groupAccess bool = false
	this.GroupAccess = &groupAccess
	var groupAccessRemove bool = false
	...
	this.Tags = tags
	var useForSubscriberList bool = false
...
// SetGroupAccess gets a reference to the given bool and assigns it to the GroupAccess field.
func (o *Product) SetGroupAccess(v bool) {
	o.GroupAccess = &v
}

// GetGroupAccessRemove returns the GroupAccessRemove field value if set, zero value otherwise.
func (o *Product) GetGroupAccessRemove() bool {
	if o == nil || IsNil(o.GroupAccessRemove) {
		var ret bool
		return ret
	}
	return *o.GroupAccessRemove
}

// GetGroupAccessRemoveOk returns a tuple with the GroupAccessRemove field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Product) GetGroupAccessRemoveOk() (*bool, bool) {
	if o == nil || IsNil(o.GroupAccessRemove) {
		return nil, false
	}
	return o.GroupAccessRemove, true
}
...
// SetGroupAccessRemove gets a reference to the given bool and assigns it to the GroupAccessRemove field.
func (o *Product) SetGroupAccessRemove(v bool) {
	o.GroupAccessRemove = &v
}
...
// GetParentListings returns the ParentListings field value
func (o *Product) GetParentListings() []string {
	...
	return o.ParentListings
}

// GetParentListingsOk returns a tuple with the ParentListings field value
// and a boolean to check if the value has been set.
func (o *Product) GetParentListingsOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
	return o.ParentListings, true
}

// SetParentListings sets field value
...
// GetUseForSubscriberList returns the UseForSubscriberList field value if set, zero value otherwise.
func (o *Product) GetUseForSubscriberList() bool {
	if o == nil || IsNil(o.UseForSubscriberList) {
		var ret bool
		return ret
	}
	return *o.UseForSubscriberList
}

// GetUseForSubscriberListOk returns a tuple with the UseForSubscriberList field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Product) GetUseForSubscriberListOk() (*bool, bool) {
	if o == nil || IsNil(o.UseForSubscriberList) {
		return nil, false
	}
	return o.UseForSubscriberList, true
}
...
// SetUseForSubscriberList gets a reference to the given bool and assigns it to the UseForSubscriberList field.
func (o *Product) SetUseForSubscriberList(v bool) {
	o.UseForSubscriberList = &v
}
...
func (o Product) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.GroupAccessRemove) {
		toSerialize["groupAccessRemove"] = o.GroupAccessRemove
	}
	if !IsNil(o.GroupId) {
	...
	toSerialize["parentListings"] = o.ParentListings
	...
	if !IsNil(o.UseForSubscriberList) {
		toSerialize["useForSubscriberList"] = o.UseForSubscriberList
	}
