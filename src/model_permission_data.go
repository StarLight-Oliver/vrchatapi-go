...
type PermissionData struct {
	...
	MaxFavoriteGroups *map[string]int32 `json:"maxFavoriteGroups,omitempty"`
	// Maximum favorites per group afforded the user by this permission
	MaxFavoritesPerGroup *map[string]int32 `json:"maxFavoritesPerGroup,omitempty"`
...
// GetMaxFavoriteGroups returns the MaxFavoriteGroups field value if set, zero value otherwise.
func (o *PermissionData) GetMaxFavoriteGroups() map[string]int32 {
	if o == nil || IsNil(o.MaxFavoriteGroups) {
...
// GetMaxFavoriteGroupsOk returns a tuple with the MaxFavoriteGroups field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetMaxFavoriteGroups gets a reference to the given map[string]int32 and assigns it to the MaxFavoriteGroups field.
func (o *PermissionData) SetMaxFavoriteGroups(v map[string]int32) {
	o.MaxFavoriteGroups = &v
}

// GetMaxFavoritesPerGroup returns the MaxFavoritesPerGroup field value if set, zero value otherwise.
func (o *PermissionData) GetMaxFavoritesPerGroup() map[string]int32 {
	if o == nil || IsNil(o.MaxFavoritesPerGroup) {
		var ret map[string]int32
		return ret
	}
...
// GetMaxFavoritesPerGroupOk returns a tuple with the MaxFavoritesPerGroup field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetMaxFavoritesPerGroup gets a reference to the given map[string]int32 and assigns it to the MaxFavoritesPerGroup field.
...
func (o PermissionData) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.MaxFavoriteGroups) {
		toSerialize["maxFavoriteGroups"] = o.MaxFavoriteGroups
	}
	if !IsNil(o.MaxFavoritesPerGroup) {
