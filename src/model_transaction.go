...
// GetIsTokens returns the IsTokens field value if set, zero value otherwise.
func (o *Transaction) GetIsTokens() bool {
	if o == nil || IsNil(o.IsTokens) {
		var ret bool
		return ret
	}
	return *o.IsTokens
...
// GetIsTokensOk returns a tuple with the IsTokens field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Transaction) GetIsTokensOk() (*bool, bool) {
	if o == nil || IsNil(o.IsTokens) {
		return nil, false
	}
	return o.IsTokens, true
}
...
// SetIsTokens gets a reference to the given bool and assigns it to the IsTokens field.
...
func (o Transaction) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsTokens) {
		toSerialize["isTokens"] = o.IsTokens
	}
