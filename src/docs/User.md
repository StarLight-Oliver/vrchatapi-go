...
**LastMobile** | Pointer to **NullableString** |  | [optional] 
...
**Location** | Pointer to **string** | Represents a unique location, consisting of a world identifier and an instance identifier, or \&quot;offline\&quot; if the user is not on your friends list. | [optional] 
...
`func NewUser(ageVerificationStatus AgeVerificationStatus, ageVerified bool, allowAvatarCopying bool, bio string, bioLinks []string, currentAvatarImageUrl string, currentAvatarTags []string, currentAvatarThumbnailImageUrl string, dateJoined string, developerType DeveloperType, displayName string, friendKey string, id string, isFriend bool, lastActivity string, lastLogin string, lastPlatform string, profilePicOverride string, profilePicOverrideThumbnail string, pronouns string, state UserState, status UserStatus, statusDescription string, tags []string, userIcon string, ) *User`
...
`func (o *User) GetAgeVerificationStatus() AgeVerificationStatus`
...
`func (o *User) GetAgeVerificationStatusOk() (*AgeVerificationStatus, bool)`
...
`func (o *User) SetAgeVerificationStatus(v AgeVerificationStatus)`
...
`func (o *User) SetAgeVerified(v bool)`
...
`func (o *User) SetBadges(v []Badge)`

SetBadges sets Badges field to given value.

### HasBadges

`func (o *User) HasBadges() bool`
...
`func (o *User) SetCurrentAvatarTags(v []string)`
...
`func (o *User) GetProfilePicOverrideThumbnail() string`
...
`func (o *User) GetProfilePicOverrideThumbnailOk() (*string, bool)`
...
`func (o *User) SetProfilePicOverrideThumbnail(v string)`
