...
**UnityPackages** | Pointer to [**[]UnityPackage**](UnityPackage.md) | Empty if unauthenticated. | [optional] 
**UpdatedAt** | **time.Time** |  | 
...
`func NewWorld(authorId string, authorName string, capacity int32, createdAt time.Time, description string, featured bool, heat int32, id string, imageUrl string, labsPublicationDate string, name string, organization string, popularity int32, publicationDate string, recommendedCapacity int32, releaseStatus ReleaseStatus, tags []string, thumbnailImageUrl string, updatedAt time.Time, version int32, visits int32, ) *World`
...
`func (o *World) GetDefaultContentSettings() InstanceContentSettings`
...
`func (o *World) GetDefaultContentSettingsOk() (*InstanceContentSettings, bool)`
...
`func (o *World) SetDefaultContentSettings(v InstanceContentSettings)`

SetDefaultContentSettings sets DefaultContentSettings field to given value.

### HasDefaultContentSettings

`func (o *World) HasDefaultContentSettings() bool`
...
`func (o *World) HasNamespace() bool`
...
`func (o *World) SetRecommendedCapacity(v int32)`
...
`func (o *World) GetStoreId() string`

GetStoreId returns the StoreId field if non-nil, zero value otherwise.

### GetStoreIdOk

`func (o *World) GetStoreIdOk() (*string, bool)`
...
`func (o *World) SetStoreId(v string)`

SetStoreId sets StoreId field to given value.

### HasStoreId

`func (o *World) HasStoreId() bool`
...
`func (o *World) SetUdonProducts(v []string)`

SetUdonProducts sets UdonProducts field to given value.

### HasUdonProducts

`func (o *World) HasUdonProducts() bool`
...
`func (o *World) HasUnityPackages() bool`
...
`func (o *World) SetUrlList(v []string)`

SetUrlList sets UrlList field to given value.

### HasUrlList

`func (o *World) HasUrlList() bool`
