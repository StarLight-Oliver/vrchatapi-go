...
func (r ApiGetActiveWorldsRequest) Noplatform(noplatform string) ApiGetActiveWorldsRequest {
	r.noplatform = &noplatform
	return r
}
...
func (a *WorldsAPIService) GetActiveWorldsExecute(r ApiGetActiveWorldsRequest) ([]LimitedWorld, *http.Response, error) {
	...
	if r.noplatform != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "noplatform", r.noplatform, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (r ApiGetFavoritedWorldsRequest) Execute() ([]FavoritedWorld, *http.Response, error) {
...
func (a *WorldsAPIService) GetFavoritedWorldsExecute(r ApiGetFavoritedWorldsRequest) ([]FavoritedWorld, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue []FavoritedWorld
	)
...
// The platform the asset does not support.
func (r ApiSearchWorldsRequest) Noplatform(noplatform string) ApiSearchWorldsRequest {
	r.noplatform = &noplatform
	return r
}

func (r ApiSearchWorldsRequest) Fuzzy(fuzzy bool) ApiSearchWorldsRequest {
	r.fuzzy = &fuzzy
	return r
}

// Only search for avatar worlds.
func (r ApiSearchWorldsRequest) AvatarSpecific(avatarSpecific bool) ApiSearchWorldsRequest {
	r.avatarSpecific = &avatarSpecific
	return r
}
...
func (a *WorldsAPIService) SearchWorldsExecute(r ApiSearchWorldsRequest) ([]LimitedWorld, *http.Response, error) {
	...
	if r.fuzzy != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "fuzzy", r.fuzzy, "form", "")
	}
	if r.avatarSpecific != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "avatarSpecific", r.avatarSpecific, "form", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
