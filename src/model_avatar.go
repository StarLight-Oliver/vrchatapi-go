...
type Avatar struct {
	...
	ActiveAssetReviewId *string `json:"activeAssetReviewId,omitempty"`
	...
	HighestPrice      *int32                         `json:"highestPrice,omitempty"`
	Id                string                         `json:"id"`
	ImageUrl          string                         `json:"imageUrl"`
	ListingDate       NullableString                 `json:"listingDate"`
	Lock              *bool                          `json:"lock,omitempty"`
	LowestPrice       *int32                         `json:"lowestPrice,omitempty"`
	Name              string                         `json:"name"`
	PendingUpload     *bool                          `json:"pendingUpload,omitempty"`
	Performance       AvatarPerformance              `json:"performance"`
	ProductId         *string                        `json:"productId,omitempty"`
	PublishedListings []AvatarPublishedListingsInner `json:"publishedListings,omitempty"`
	ReleaseStatus     ReleaseStatus                  `json:"releaseStatus"`
	Searchable        *bool                          `json:"searchable,omitempty"`
	Styles            AvatarStyles                   `json:"styles"`
	//
...
// SetAcknowledgements gets a reference to the given string and assigns it to the Acknowledgements field.
func (o *Avatar) SetAcknowledgements(v string) {
	o.Acknowledgements = &v
}

// GetActiveAssetReviewId returns the ActiveAssetReviewId field value if set, zero value otherwise.
func (o *Avatar) GetActiveAssetReviewId() string {
	if o == nil || IsNil(o.ActiveAssetReviewId) {
		var ret string
		return ret
	}
	return *o.ActiveAssetReviewId
}

// GetActiveAssetReviewIdOk returns a tuple with the ActiveAssetReviewId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Avatar) GetActiveAssetReviewIdOk() (*string, bool) {
	if o == nil || IsNil(o.ActiveAssetReviewId) {
		return nil, false
	}
	return o.ActiveAssetReviewId, true
}
...
// SetActiveAssetReviewId gets a reference to the given string and assigns it to the ActiveAssetReviewId field.
func (o *Avatar) SetActiveAssetReviewId(v string) {
	o.ActiveAssetReviewId = &v
}
...
// SetHighestPrice gets a reference to the given int32 and assigns it to the HighestPrice field.
...
// GetListingDate returns the ListingDate field value
// If the value is explicit nil, the zero value for string will be returned
func (o *Avatar) GetListingDate() string {
	if o == nil || o.ListingDate.Get() == nil {
		var ret string
		return ret
	}

	return *o.ListingDate.Get()
}

// GetListingDateOk returns a tuple with the ListingDate field value
// and a boolean to check if the value has been set.
...
func (o *Avatar) GetListingDateOk() (*string, bool) {
	...
	return o.ListingDate.Get(), o.ListingDate.IsSet()
}

// SetListingDate sets field value
...
// SetLowestPrice gets a reference to the given int32 and assigns it to the LowestPrice field.
...
// GetPendingUpload returns the PendingUpload field value if set, zero value otherwise.
func (o *Avatar) GetPendingUpload() bool {
	if o == nil || IsNil(o.PendingUpload) {
		var ret bool
		return ret
	}
	return *o.PendingUpload
}

// GetPendingUploadOk returns a tuple with the PendingUpload field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Avatar) GetPendingUploadOk() (*bool, bool) {
	if o == nil || IsNil(o.PendingUpload) {
		return nil, false
	}
	return o.PendingUpload, true
}
...
// SetPendingUpload gets a reference to the given bool and assigns it to the PendingUpload field.
...
// GetPublishedListings returns the PublishedListings field value if set, zero value otherwise.
func (o *Avatar) GetPublishedListings() []AvatarPublishedListingsInner {
	if o == nil || IsNil(o.PublishedListings) {
		var ret []AvatarPublishedListingsInner
		return ret
	}
	return o.PublishedListings
}

// GetPublishedListingsOk returns a tuple with the PublishedListings field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Avatar) GetPublishedListingsOk() ([]AvatarPublishedListingsInner, bool) {
	if o == nil || IsNil(o.PublishedListings) {
		return nil, false
	}
	return o.PublishedListings, true
}
...
// SetPublishedListings gets a reference to the given []AvatarPublishedListingsInner and assigns it to the PublishedListings field.
func (o *Avatar) SetPublishedListings(v []AvatarPublishedListingsInner) {
	o.PublishedListings = v
}
...
func (o Avatar) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ActiveAssetReviewId) {
		toSerialize["activeAssetReviewId"] = o.ActiveAssetReviewId
	}
	if !IsNil(o.AssetUrl) {
	...
	if !IsNil(o.HighestPrice) {
		toSerialize["highestPrice"] = o.HighestPrice
	}
	toSerialize["id"] = o.Id
	toSerialize["imageUrl"] = o.ImageUrl
	toSerialize["listingDate"] = o.ListingDate.Get()
	if !IsNil(o.Lock) {
		toSerialize["lock"] = o.Lock
	}
	if !IsNil(o.LowestPrice) {
		toSerialize["lowestPrice"] = o.LowestPrice
	}
	toSerialize["name"] = o.Name
	if !IsNil(o.PendingUpload) {
		toSerialize["pendingUpload"] = o.PendingUpload
	}
	toSerialize["performance"] = o.Performance
	if !IsNil(o.ProductId) {
		toSerialize["productId"] = o.ProductId
	}
	if !IsNil(o.PublishedListings) {
		toSerialize["publishedListings"] = o.PublishedListings
	}
