...
type _UpdateInviteMessageRequest UpdateInviteMessageRequest
...
func (o *UpdateInviteMessageRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateInviteMessageRequest := _UpdateInviteMessageRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateInviteMessageRequest)

	if err != nil {
		return err
	}

	*o = UpdateInviteMessageRequest(varUpdateInviteMessageRequest)
