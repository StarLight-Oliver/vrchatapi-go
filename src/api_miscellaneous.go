...
*/
func (a *MiscellaneousAPIService) GetAssignedPermissions(ctx context.Context) ApiGetAssignedPermissionsRequest {
	return ApiGetAssignedPermissionsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []Permission
func (a *MiscellaneousAPIService) GetAssignedPermissionsExecute(r ApiGetAssignedPermissionsRequest) ([]Permission, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MiscellaneousAPIService.GetAssignedPermissions")
	if err != nil {
...
*/
func (a *MiscellaneousAPIService) GetCSS(ctx context.Context) ApiGetCSSRequest {
	return ApiGetCSSRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return string
func (a *MiscellaneousAPIService) GetCSSExecute(r ApiGetCSSRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MiscellaneousAPIService.GetCSS")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *MiscellaneousAPIService) GetConfig(ctx context.Context) ApiGetConfigRequest {
	return ApiGetConfigRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return APIConfig
func (a *MiscellaneousAPIService) GetConfigExecute(r ApiGetConfigRequest) (*APIConfig, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MiscellaneousAPIService.GetConfig")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *MiscellaneousAPIService) GetCurrentOnlineUsers(ctx context.Context) ApiGetCurrentOnlineUsersRequest {
	return ApiGetCurrentOnlineUsersRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return int32
func (a *MiscellaneousAPIService) GetCurrentOnlineUsersExecute(r ApiGetCurrentOnlineUsersRequest) (int32, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MiscellaneousAPIService.GetCurrentOnlineUsers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
Deprecated
*/
func (a *MiscellaneousAPIService) GetHealth(ctx context.Context) ApiGetHealthRequest {
	return ApiGetHealthRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
// Deprecated
func (a *MiscellaneousAPIService) GetHealthExecute(r ApiGetHealthRequest) (*APIHealth, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MiscellaneousAPIService.GetHealth")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *MiscellaneousAPIService) GetInfoPush(ctx context.Context) ApiGetInfoPushRequest {
	return ApiGetInfoPushRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return []InfoPush
func (a *MiscellaneousAPIService) GetInfoPushExecute(r ApiGetInfoPushRequest) ([]InfoPush, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MiscellaneousAPIService.GetInfoPush")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	if r.require != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "require", r.require, "form", "")
	}
	if r.include != nil {
...
*/
func (a *MiscellaneousAPIService) GetJavaScript(ctx context.Context) ApiGetJavaScriptRequest {
	return ApiGetJavaScriptRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return string
func (a *MiscellaneousAPIService) GetJavaScriptExecute(r ApiGetJavaScriptRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MiscellaneousAPIService.GetJavaScript")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *MiscellaneousAPIService) GetPermission(ctx context.Context, permissionId string) ApiGetPermissionRequest {
	return ApiGetPermissionRequest{
		ApiService:   a,
		ctx:          ctx,
...
//
//	@return Permission
func (a *MiscellaneousAPIService) GetPermissionExecute(r ApiGetPermissionRequest) (*Permission, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MiscellaneousAPIService.GetPermission")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *MiscellaneousAPIService) GetSystemTime(ctx context.Context) ApiGetSystemTimeRequest {
	return ApiGetSystemTimeRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return time.Time
func (a *MiscellaneousAPIService) GetSystemTimeExecute(r ApiGetSystemTimeRequest) (*time.Time, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MiscellaneousAPIService.GetSystemTime")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
