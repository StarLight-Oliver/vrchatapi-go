...
func (r ApiInviteUserWithPhotoRequest) Image(image *os.File) ApiInviteUserWithPhotoRequest {
	r.image = image
	return r
}

func (r ApiInviteUserWithPhotoRequest) Execute() (*SentNotification, *http.Response, error) {
	return r.ApiService.InviteUserWithPhotoExecute(r)
}

/*
InviteUserWithPhoto Invite User with photo
...
// The binary blob of the png file.
func (r ApiRequestInviteWithPhotoRequest) Image(image *os.File) ApiRequestInviteWithPhotoRequest {
	r.image = image
	return r
}

func (r ApiRequestInviteWithPhotoRequest) Execute() (*Notification, *http.Response, error) {
	return r.ApiService.RequestInviteWithPhotoExecute(r)
}

/*
RequestInviteWithPhoto Request Invite with photo
...
func (a *InviteAPIService) RespondInviteExecute(r ApiRespondInviteRequest) (*Notification, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.inviteResponse == nil {
		return localVarReturnValue, nil, reportError("inviteResponse is required and must be specified")
	}
...
// The binary blob of the png file.
func (r ApiRespondInviteWithPhotoRequest) Image(image *os.File) ApiRespondInviteWithPhotoRequest {
	r.image = image
	return r
}

func (r ApiRespondInviteWithPhotoRequest) Execute() (*Notification, *http.Response, error) {
	return r.ApiService.RespondInviteWithPhotoExecute(r)
}

/*
RespondInviteWithPhoto Respond Invite with photo
