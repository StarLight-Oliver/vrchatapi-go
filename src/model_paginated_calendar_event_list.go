...
// checks if the PaginatedCalendarEventList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedCalendarEventList{}
...
func NewPaginatedCalendarEventList() *PaginatedCalendarEventList {
	this := PaginatedCalendarEventList{}
	return &this
}
...
// SetResults gets a reference to the given []CalendarEvent and assigns it to the Results field.
...
func (o PaginatedCalendarEventList) ToMap() (map[string]interface{}, error) {
...
type NullablePaginatedCalendarEventList struct {
	value *PaginatedCalendarEventList
	isSet bool
}

func (v NullablePaginatedCalendarEventList) Get() *PaginatedCalendarEventList {
	return v.value
}

func (v *NullablePaginatedCalendarEventList) Set(val *PaginatedCalendarEventList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedCalendarEventList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedCalendarEventList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedCalendarEventList(val *PaginatedCalendarEventList) *NullablePaginatedCalendarEventList {
	return &NullablePaginatedCalendarEventList{value: val, isSet: true}
}

func (v NullablePaginatedCalendarEventList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedCalendarEventList) UnmarshalJSON(src []byte) error {
	v.isSet = true
