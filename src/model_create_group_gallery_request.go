...
type _CreateGroupGalleryRequest CreateGroupGalleryRequest
...
func (o *CreateGroupGalleryRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CreateGroupGalleryRequest(varCreateGroupGalleryRequest)
