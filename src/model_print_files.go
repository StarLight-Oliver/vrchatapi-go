...
// checks if the PrintFiles type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PrintFiles{}

// PrintFiles struct for PrintFiles
...
func (o PrintFiles) MarshalJSON() ([]byte, error) {
...
func (o PrintFiles) ToMap() (map[string]interface{}, error) {
...
type NullablePrintFiles struct {
	value *PrintFiles
	isSet bool
}

func (v NullablePrintFiles) Get() *PrintFiles {
	return v.value
}

func (v *NullablePrintFiles) Set(val *PrintFiles) {
	v.value = val
	v.isSet = true
}

func (v NullablePrintFiles) IsSet() bool {
	return v.isSet
}

func (v *NullablePrintFiles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrintFiles(val *PrintFiles) *NullablePrintFiles {
	return &NullablePrintFiles{value: val, isSet: true}
}

func (v NullablePrintFiles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrintFiles) UnmarshalJSON(src []byte) error {
	v.isSet = true
