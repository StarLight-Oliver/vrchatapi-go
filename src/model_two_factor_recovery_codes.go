...
// checks if the TwoFactorRecoveryCodes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TwoFactorRecoveryCodes{}
...
func (o *TwoFactorRecoveryCodes) GetOtp() []TwoFactorRecoveryCodesOtpInner {
	if o == nil || IsNil(o.Otp) {
		var ret []TwoFactorRecoveryCodesOtpInner
		return ret
	}
	return o.Otp
}
...
// SetOtp gets a reference to the given []TwoFactorRecoveryCodesOtpInner and assigns it to the Otp field.
...
// SetRequiresTwoFactorAuth gets a reference to the given []string and assigns it to the RequiresTwoFactorAuth field.
...
func (o TwoFactorRecoveryCodes) ToMap() (map[string]interface{}, error) {
...
type NullableTwoFactorRecoveryCodes struct {
	value *TwoFactorRecoveryCodes
	isSet bool
}

func (v NullableTwoFactorRecoveryCodes) Get() *TwoFactorRecoveryCodes {
	return v.value
}

func (v *NullableTwoFactorRecoveryCodes) Set(val *TwoFactorRecoveryCodes) {
	v.value = val
	v.isSet = true
}

func (v NullableTwoFactorRecoveryCodes) IsSet() bool {
	return v.isSet
}

func (v *NullableTwoFactorRecoveryCodes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTwoFactorRecoveryCodes(val *TwoFactorRecoveryCodes) *NullableTwoFactorRecoveryCodes {
	return &NullableTwoFactorRecoveryCodes{value: val, isSet: true}
}

func (v NullableTwoFactorRecoveryCodes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTwoFactorRecoveryCodes) UnmarshalJSON(src []byte) error {
	v.isSet = true
