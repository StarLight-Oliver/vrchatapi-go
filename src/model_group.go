...
type Group struct {
	...
	AgeVerificationBetaSlots      *float32           `json:"ageVerificationBetaSlots,omitempty"`
	AgeVerificationSlotsAvailable *bool              `json:"ageVerificationSlotsAvailable,omitempty"`
	AllowGroupJoinPrompt          *bool              `json:"allowGroupJoinPrompt,omitempty"`
...
// GetAgeVerificationBetaCode returns the AgeVerificationBetaCode field value if set, zero value otherwise.
func (o *Group) GetAgeVerificationBetaCode() string {
	if o == nil || IsNil(o.AgeVerificationBetaCode) {
		var ret string
		return ret
	}
	return *o.AgeVerificationBetaCode
}

// GetAgeVerificationBetaCodeOk returns a tuple with the AgeVerificationBetaCode field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Group) GetAgeVerificationBetaCodeOk() (*string, bool) {
	if o == nil || IsNil(o.AgeVerificationBetaCode) {
		return nil, false
	}
	return o.AgeVerificationBetaCode, true
}

// HasAgeVerificationBetaCode returns a boolean if a field has been set.
func (o *Group) HasAgeVerificationBetaCode() bool {
	if o != nil && !IsNil(o.AgeVerificationBetaCode) {
		return true
	}
...
// SetAgeVerificationBetaCode gets a reference to the given string and assigns it to the AgeVerificationBetaCode field.
func (o *Group) SetAgeVerificationBetaCode(v string) {
	o.AgeVerificationBetaCode = &v
}

// GetAgeVerificationBetaSlots returns the AgeVerificationBetaSlots field value if set, zero value otherwise.
func (o *Group) GetAgeVerificationBetaSlots() float32 {
	if o == nil || IsNil(o.AgeVerificationBetaSlots) {
		var ret float32
		return ret
	}
	return *o.AgeVerificationBetaSlots
}

// GetAgeVerificationBetaSlotsOk returns a tuple with the AgeVerificationBetaSlots field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Group) GetAgeVerificationBetaSlotsOk() (*float32, bool) {
	if o == nil || IsNil(o.AgeVerificationBetaSlots) {
		return nil, false
	}
	return o.AgeVerificationBetaSlots, true
}

// HasAgeVerificationBetaSlots returns a boolean if a field has been set.
func (o *Group) HasAgeVerificationBetaSlots() bool {
	if o != nil && !IsNil(o.AgeVerificationBetaSlots) {
		return true
	}
...
// SetAgeVerificationBetaSlots gets a reference to the given float32 and assigns it to the AgeVerificationBetaSlots field.
func (o *Group) SetAgeVerificationBetaSlots(v float32) {
	o.AgeVerificationBetaSlots = &v
}

// GetAgeVerificationSlotsAvailable returns the AgeVerificationSlotsAvailable field value if set, zero value otherwise.
func (o *Group) GetAgeVerificationSlotsAvailable() bool {
	if o == nil || IsNil(o.AgeVerificationSlotsAvailable) {
		var ret bool
		return ret
	}
	return *o.AgeVerificationSlotsAvailable
}

// GetAgeVerificationSlotsAvailableOk returns a tuple with the AgeVerificationSlotsAvailable field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Group) GetAgeVerificationSlotsAvailableOk() (*bool, bool) {
	if o == nil || IsNil(o.AgeVerificationSlotsAvailable) {
		return nil, false
	}
	return o.AgeVerificationSlotsAvailable, true
}

// HasAgeVerificationSlotsAvailable returns a boolean if a field has been set.
func (o *Group) HasAgeVerificationSlotsAvailable() bool {
	if o != nil && !IsNil(o.AgeVerificationSlotsAvailable) {
		return true
	}
...
// SetAgeVerificationSlotsAvailable gets a reference to the given bool and assigns it to the AgeVerificationSlotsAvailable field.
func (o *Group) SetAgeVerificationSlotsAvailable(v bool) {
	o.AgeVerificationSlotsAvailable = &v
}

// GetAllowGroupJoinPrompt returns the AllowGroupJoinPrompt field value if set, zero value otherwise.
func (o *Group) GetAllowGroupJoinPrompt() bool {
	if o == nil || IsNil(o.AllowGroupJoinPrompt) {
		var ret bool
		return ret
	}
	return *o.AllowGroupJoinPrompt
}

// GetAllowGroupJoinPromptOk returns a tuple with the AllowGroupJoinPrompt field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Group) GetAllowGroupJoinPromptOk() (*bool, bool) {
	if o == nil || IsNil(o.AllowGroupJoinPrompt) {
		return nil, false
	}
	return o.AllowGroupJoinPrompt, true
}

// HasAllowGroupJoinPrompt returns a boolean if a field has been set.
func (o *Group) HasAllowGroupJoinPrompt() bool {
	if o != nil && !IsNil(o.AllowGroupJoinPrompt) {
		return true
	}
...
// SetAllowGroupJoinPrompt gets a reference to the given bool and assigns it to the AllowGroupJoinPrompt field.
func (o *Group) SetAllowGroupJoinPrompt(v bool) {
	o.AllowGroupJoinPrompt = &v
}

// GetBadges returns the Badges field value if set, zero value otherwise.
func (o *Group) GetBadges() []string {
...
// and a boolean to check if the value has been set.
func (o *Group) GetBadgesOk() ([]string, bool) {
	if o == nil || IsNil(o.Badges) {
		return nil, false
	}
...
func (o *Group) SetBadges(v []string) {
	o.Badges = v
}
...
func (o *Group) GetLastPostCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Group) GetLastPostCreatedAtOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Group) HasLastPostCreatedAt() bool {
...
func (o *Group) UnsetLastPostCreatedAt() {
...
// GetTransferTargetId returns the TransferTargetId field value if set, zero value otherwise.
func (o *Group) GetTransferTargetId() string {
	if o == nil || IsNil(o.TransferTargetId) {
		var ret string
		return ret
	}
	return *o.TransferTargetId
}

// GetTransferTargetIdOk returns a tuple with the TransferTargetId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Group) GetTransferTargetIdOk() (*string, bool) {
	if o == nil || IsNil(o.TransferTargetId) {
		return nil, false
	}
	return o.TransferTargetId, true
}

// HasTransferTargetId returns a boolean if a field has been set.
func (o *Group) HasTransferTargetId() bool {
	if o != nil && !IsNil(o.TransferTargetId) {
		return true
	}
...
// SetTransferTargetId gets a reference to the given string and assigns it to the TransferTargetId field.
func (o *Group) SetTransferTargetId(v string) {
	o.TransferTargetId = &v
}
...
func (o Group) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AgeVerificationBetaCode) {
		toSerialize["ageVerificationBetaCode"] = o.AgeVerificationBetaCode
	}
	if !IsNil(o.AgeVerificationBetaSlots) {
		toSerialize["ageVerificationBetaSlots"] = o.AgeVerificationBetaSlots
	}
	if !IsNil(o.AgeVerificationSlotsAvailable) {
		toSerialize["ageVerificationSlotsAvailable"] = o.AgeVerificationSlotsAvailable
	}
	if !IsNil(o.AllowGroupJoinPrompt) {
		toSerialize["allowGroupJoinPrompt"] = o.AllowGroupJoinPrompt
	}
	if !IsNil(o.Badges) {
	...
	if !IsNil(o.TransferTargetId) {
		toSerialize["transferTargetId"] = o.TransferTargetId
	}
