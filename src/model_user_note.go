...
// SetTargetUser gets a reference to the given UserNoteTargetUser and assigns it to the TargetUser field.
...
func (o *UserNote) UnmarshalJSON(data []byte) (err error) {
