...
// checks if the GroupRoleTemplateValuesRoles type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GroupRoleTemplateValuesRoles{}
...
func NewGroupRoleTemplateValuesRoles() *GroupRoleTemplateValuesRoles {
	this := GroupRoleTemplateValuesRoles{}
	var isAddedOnJoin bool = false
...
func (o *GroupRoleTemplateValuesRoles) GetBasePermissions() []GroupPermissions {
	if o == nil || IsNil(o.BasePermissions) {
...
// SetBasePermissions gets a reference to the given []GroupPermissions and assigns it to the BasePermissions field.
func (o *GroupRoleTemplateValuesRoles) SetBasePermissions(v []GroupPermissions) {
	o.BasePermissions = v
}

// GetIsAddedOnJoin returns the IsAddedOnJoin field value if set, zero value otherwise.
func (o *GroupRoleTemplateValuesRoles) GetIsAddedOnJoin() bool {
	if o == nil || IsNil(o.IsAddedOnJoin) {
		var ret bool
		return ret
	}
	return *o.IsAddedOnJoin
}

// GetIsAddedOnJoinOk returns a tuple with the IsAddedOnJoin field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GroupRoleTemplateValuesRoles) GetIsAddedOnJoinOk() (*bool, bool) {
	if o == nil || IsNil(o.IsAddedOnJoin) {
		return nil, false
	}
	return o.IsAddedOnJoin, true
}
...
// SetIsAddedOnJoin gets a reference to the given bool and assigns it to the IsAddedOnJoin field.
...
func (o GroupRoleTemplateValuesRoles) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.BasePermissions) {
		toSerialize["basePermissions"] = o.BasePermissions
	}
	if !IsNil(o.IsAddedOnJoin) {
		toSerialize["isAddedOnJoin"] = o.IsAddedOnJoin
	}
	return toSerialize, nil
}

type NullableGroupRoleTemplateValuesRoles struct {
	value *GroupRoleTemplateValuesRoles
	isSet bool
}

func (v NullableGroupRoleTemplateValuesRoles) Get() *GroupRoleTemplateValuesRoles {
	return v.value
}

func (v *NullableGroupRoleTemplateValuesRoles) Set(val *GroupRoleTemplateValuesRoles) {
	v.value = val
	v.isSet = true
}

func (v NullableGroupRoleTemplateValuesRoles) IsSet() bool {
	return v.isSet
}

func (v *NullableGroupRoleTemplateValuesRoles) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGroupRoleTemplateValuesRoles(val *GroupRoleTemplateValuesRoles) *NullableGroupRoleTemplateValuesRoles {
	return &NullableGroupRoleTemplateValuesRoles{value: val, isSet: true}
}

func (v NullableGroupRoleTemplateValuesRoles) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGroupRoleTemplateValuesRoles) UnmarshalJSON(src []byte) error {
	v.isSet = true
