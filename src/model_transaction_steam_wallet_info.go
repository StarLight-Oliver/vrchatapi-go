...
type _TransactionSteamWalletInfo TransactionSteamWalletInfo
...
func NewTransactionSteamWalletInfo(country string, currency string, state string, status string) *TransactionSteamWalletInfo {
...
func (o *TransactionSteamWalletInfo) UnmarshalJSON(data []byte) (err error) {
	...
	*o = TransactionSteamWalletInfo(varTransactionSteamWalletInfo)
