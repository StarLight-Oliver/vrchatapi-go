...
type _FinishFileDataUploadRequest FinishFileDataUploadRequest
...
func NewFinishFileDataUploadRequest(maxParts string, nextPartNumber string) *FinishFileDataUploadRequest {
...
func (o *FinishFileDataUploadRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = FinishFileDataUploadRequest(varFinishFileDataUploadRequest)
