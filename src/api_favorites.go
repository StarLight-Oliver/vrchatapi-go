...
func (r ApiGetFavoriteGroupsRequest) UserId(userId string) ApiGetFavoriteGroupsRequest {
	r.userId = &userId
	return r
}
...
func (r ApiGetFavoriteLimitsRequest) Execute() (*FavoriteLimits, *http.Response, error) {
	return r.ApiService.GetFavoriteLimitsExecute(r)
}

/*
GetFavoriteLimits Get Favorite Limits
...
func (a *FavoritesAPIService) GetFavoriteLimitsExecute(r ApiGetFavoriteLimitsRequest) (*FavoriteLimits, *http.Response, error) {
	...
	localVarPath := localBasePath + "/auth/user/favoritelimits"
