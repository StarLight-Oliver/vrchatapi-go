...
func (r ApiDeletePrintRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeletePrintExecute(r)
}
...
func (r ApiEditPrintRequest) Image(image *os.File) ApiEditPrintRequest {
	r.image = image
	return r
}

// The caption for the image.
func (r ApiEditPrintRequest) Note(note string) ApiEditPrintRequest {
	r.note = &note
	return r
}

func (r ApiEditPrintRequest) Execute() (*Print, *http.Response, error) {
	return r.ApiService.EditPrintExecute(r)
}

/*
EditPrint Edit Print
...
func (r ApiGetPrintRequest) Execute() (*Print, *http.Response, error) {
	return r.ApiService.GetPrintExecute(r)
}
...
func (r ApiGetUserPrintsRequest) Execute() ([]Print, *http.Response, error) {
	return r.ApiService.GetUserPrintsExecute(r)
}

/*
GetUserPrints Get Own Prints
...
// The binary blob of the png file.
func (r ApiUploadPrintRequest) Image(image *os.File) ApiUploadPrintRequest {
	r.image = image
	return r
}

// The time the image was captured.
func (r ApiUploadPrintRequest) Timestamp(timestamp time.Time) ApiUploadPrintRequest {
	r.timestamp = &timestamp
	return r
}

// The caption for the image.
func (r ApiUploadPrintRequest) Note(note string) ApiUploadPrintRequest {
	r.note = &note
	return r
}

// The id of the world in which the image was captured.
func (r ApiUploadPrintRequest) WorldId(worldId string) ApiUploadPrintRequest {
	r.worldId = &worldId
	return r
}

// The name of the world in which the image was captured.
func (r ApiUploadPrintRequest) WorldName(worldName string) ApiUploadPrintRequest {
	r.worldName = &worldName
	return r
}

func (r ApiUploadPrintRequest) Execute() (*Print, *http.Response, error) {
	return r.ApiService.UploadPrintExecute(r)
}
...
func (a *PrintsAPIService) UploadPrintExecute(r ApiUploadPrintRequest) (*Print, *http.Response, error) {
	...
	localVarPath := localBasePath + "/prints"
	...
	if r.worldId != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "worldId", r.worldId, "", "")
	}
	if r.worldName != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "worldName", r.worldName, "", "")
	}
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
