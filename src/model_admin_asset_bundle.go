...
// checks if the AdminAssetBundle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AdminAssetBundle{}
...
type _AdminAssetBundle AdminAssetBundle
...
func (o AdminAssetBundle) MarshalJSON() ([]byte, error) {
...
func (o AdminAssetBundle) ToMap() (map[string]interface{}, error) {
...
func (o *AdminAssetBundle) UnmarshalJSON(data []byte) (err error) {
	...
	*o = AdminAssetBundle(varAdminAssetBundle)

	return err
}

type NullableAdminAssetBundle struct {
	value *AdminAssetBundle
	isSet bool
}

func (v NullableAdminAssetBundle) Get() *AdminAssetBundle {
	return v.value
}

func (v *NullableAdminAssetBundle) Set(val *AdminAssetBundle) {
	v.value = val
	v.isSet = true
}

func (v NullableAdminAssetBundle) IsSet() bool {
	return v.isSet
}

func (v *NullableAdminAssetBundle) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdminAssetBundle(val *AdminAssetBundle) *NullableAdminAssetBundle {
	return &NullableAdminAssetBundle{value: val, isSet: true}
}

func (v NullableAdminAssetBundle) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdminAssetBundle) UnmarshalJSON(src []byte) error {
	v.isSet = true
