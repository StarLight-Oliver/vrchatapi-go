...
// GetCurrentAvatarThumbnailImageUrl returns the CurrentAvatarThumbnailImageUrl field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *GroupMemberLimitedUser) GetCurrentAvatarThumbnailImageUrl() string {
	if o == nil || IsNil(o.CurrentAvatarThumbnailImageUrl.Get()) {
		var ret string
		return ret
	}
	return *o.CurrentAvatarThumbnailImageUrl.Get()
}
...
func (o *GroupMemberLimitedUser) GetCurrentAvatarThumbnailImageUrlOk() (*string, bool) {
	...
	return o.CurrentAvatarThumbnailImageUrl.Get(), o.CurrentAvatarThumbnailImageUrl.IsSet()
}
...
func (o *GroupMemberLimitedUser) HasCurrentAvatarThumbnailImageUrl() bool {
	if o != nil && o.CurrentAvatarThumbnailImageUrl.IsSet() {
		return true
	}
...
// SetCurrentAvatarThumbnailImageUrl gets a reference to the given NullableString and assigns it to the CurrentAvatarThumbnailImageUrl field.
...
func (o *GroupMemberLimitedUser) UnsetCurrentAvatarThumbnailImageUrl() {
	o.CurrentAvatarThumbnailImageUrl.Unset()
}
...
func (o GroupMemberLimitedUser) ToMap() (map[string]interface{}, error) {
	...
	if o.CurrentAvatarThumbnailImageUrl.IsSet() {
		toSerialize["currentAvatarThumbnailImageUrl"] = o.CurrentAvatarThumbnailImageUrl.Get()
	}
