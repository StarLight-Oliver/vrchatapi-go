...
// checks if the SubmitModerationReportRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubmitModerationReportRequest{}
...
type _SubmitModerationReportRequest SubmitModerationReportRequest
...
func NewSubmitModerationReportRequest(category string, contentId string, reason string, type_ string) *SubmitModerationReportRequest {
	this := SubmitModerationReportRequest{}
...
func (o *SubmitModerationReportRequest) GetDetails() SubmitModerationReportRequestDetails {
	if o == nil || IsNil(o.Details) {
		var ret SubmitModerationReportRequestDetails
		return ret
	}
	return *o.Details
}
...
// SetDetails gets a reference to the given SubmitModerationReportRequestDetails and assigns it to the Details field.
...
func (o SubmitModerationReportRequest) ToMap() (map[string]interface{}, error) {
...
func (o *SubmitModerationReportRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = SubmitModerationReportRequest(varSubmitModerationReportRequest)

	return err
}

type NullableSubmitModerationReportRequest struct {
	value *SubmitModerationReportRequest
	isSet bool
}

func (v NullableSubmitModerationReportRequest) Get() *SubmitModerationReportRequest {
	return v.value
}

func (v *NullableSubmitModerationReportRequest) Set(val *SubmitModerationReportRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableSubmitModerationReportRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableSubmitModerationReportRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubmitModerationReportRequest(val *SubmitModerationReportRequest) *NullableSubmitModerationReportRequest {
	return &NullableSubmitModerationReportRequest{value: val, isSet: true}
}

func (v NullableSubmitModerationReportRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubmitModerationReportRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
