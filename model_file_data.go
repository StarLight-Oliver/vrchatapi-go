...
type _FileData FileData

// NewFileData instantiates a new FileData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewFileData(category string, fileName string, sizeInBytes int32, status FileStatus, uploadId string, url string) *FileData {
	this := FileData{}
...
func (o *FileData) UnmarshalJSON(data []byte) (err error) {
