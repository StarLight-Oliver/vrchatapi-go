...
// checks if the CurrentUserPlatformHistoryInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CurrentUserPlatformHistoryInner{}

// CurrentUserPlatformHistoryInner struct for CurrentUserPlatformHistoryInner
...
func NewCurrentUserPlatformHistoryInner() *CurrentUserPlatformHistoryInner {
	this := CurrentUserPlatformHistoryInner{}
	return &this
}
...
// SetRecorded gets a reference to the given time.Time and assigns it to the Recorded field.
...
func (o CurrentUserPlatformHistoryInner) ToMap() (map[string]interface{}, error) {
...
type NullableCurrentUserPlatformHistoryInner struct {
	value *CurrentUserPlatformHistoryInner
	isSet bool
}

func (v NullableCurrentUserPlatformHistoryInner) Get() *CurrentUserPlatformHistoryInner {
	return v.value
}

func (v *NullableCurrentUserPlatformHistoryInner) Set(val *CurrentUserPlatformHistoryInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCurrentUserPlatformHistoryInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCurrentUserPlatformHistoryInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCurrentUserPlatformHistoryInner(val *CurrentUserPlatformHistoryInner) *NullableCurrentUserPlatformHistoryInner {
	return &NullableCurrentUserPlatformHistoryInner{value: val, isSet: true}
}

func (v NullableCurrentUserPlatformHistoryInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCurrentUserPlatformHistoryInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
