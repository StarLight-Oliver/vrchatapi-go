...
// checks if the ReportCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReportCategory{}
...
type _ReportCategory ReportCategory
...
func (o ReportCategory) MarshalJSON() ([]byte, error) {
...
func (o ReportCategory) ToMap() (map[string]interface{}, error) {
...
func (o *ReportCategory) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ReportCategory(varReportCategory)

	return err
}

type NullableReportCategory struct {
	value *ReportCategory
	isSet bool
}

func (v NullableReportCategory) Get() *ReportCategory {
	return v.value
}

func (v *NullableReportCategory) Set(val *ReportCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableReportCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableReportCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportCategory(val *ReportCategory) *NullableReportCategory {
	return &NullableReportCategory{value: val, isSet: true}
}

func (v NullableReportCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
