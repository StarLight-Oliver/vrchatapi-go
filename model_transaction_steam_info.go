...
type _TransactionSteamInfo TransactionSteamInfo

// NewTransactionSteamInfo instantiates a new TransactionSteamInfo object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTransactionSteamInfo(orderId string, steamId string, steamUrl string, transId string, walletInfo TransactionSteamWalletInfo) *TransactionSteamInfo {
...
func (o *TransactionSteamInfo) UnmarshalJSON(data []byte) (err error) {
	...
	*o = TransactionSteamInfo(varTransactionSteamInfo)
