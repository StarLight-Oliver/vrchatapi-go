...
type _BanGroupMemberRequest BanGroupMemberRequest
...
func (o *BanGroupMemberRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = BanGroupMemberRequest(varBanGroupMemberRequest)
