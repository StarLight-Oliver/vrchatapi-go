...
func (r ApiAcknowledgeNotificationV2Request) Execute() (*NotificationV2, *http.Response, error) {
	return r.ApiService.AcknowledgeNotificationV2Execute(r)
}

/*
AcknowledgeNotificationV2 Acknowledge NotificationV2
...
func (r ApiDeleteAllNotificationV2sRequest) Execute() (*Success, *http.Response, error) {
	return r.ApiService.DeleteAllNotificationV2sExecute(r)
}

/*
DeleteAllNotificationV2s Delete All NotificationV2s
...
func (r ApiDeleteNotificationV2Request) Execute() (*Success, *http.Response, error) {
	return r.ApiService.DeleteNotificationV2Execute(r)
}

/*
DeleteNotificationV2 Delete NotificationV2
...
/*
GetNotification Show notification
...
func (r ApiGetNotificationV2Request) Execute() (*NotificationV2, *http.Response, error) {
	return r.ApiService.GetNotificationV2Execute(r)
}

/*
GetNotificationV2 Get NotificationV2
...
func (r ApiGetNotificationV2sRequest) Limit(limit int32) ApiGetNotificationV2sRequest {
	r.limit = &limit
	return r
}

func (r ApiGetNotificationV2sRequest) Execute() ([]NotificationV2, *http.Response, error) {
	return r.ApiService.GetNotificationV2sExecute(r)
}

/*
GetNotificationV2s List NotificationV2s
...
func (r ApiReplyNotificationV2Request) Execute() (*NotificationV2, *http.Response, error) {
	return r.ApiService.ReplyNotificationV2Execute(r)
}

/*
ReplyNotificationV2 Reply NotificationV2
...
func (r ApiRespondNotificationV2Request) RespondNotificationV2Request(respondNotificationV2Request RespondNotificationV2Request) ApiRespondNotificationV2Request {
	r.respondNotificationV2Request = &respondNotificationV2Request
	return r
}

func (r ApiRespondNotificationV2Request) Execute() (*NotificationV2, *http.Response, error) {
	return r.ApiService.RespondNotificationV2Execute(r)
}

/*
RespondNotificationV2 Respond NotificationV2
...
func (a *NotificationsAPIService) RespondNotificationV2Execute(r ApiRespondNotificationV2Request) (*NotificationV2, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.respondNotificationV2Request == nil {
		return localVarReturnValue, nil, reportError("respondNotificationV2Request is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.respondNotificationV2Request
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
