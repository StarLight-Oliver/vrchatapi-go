...
func (r ApiGetPlayerModerationsRequest) Type_(type_ PlayerModerationType) ApiGetPlayerModerationsRequest {
	r.type_ = &type_
	return r
}
...
func (a *PlayermoderationAPIService) ModerateUserExecute(r ApiModerateUserRequest) (*PlayerModeration, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.moderateUserRequest == nil {
		return localVarReturnValue, nil, reportError("moderateUserRequest is required and must be specified")
	}
