...
type _InfoPush InfoPush

// NewInfoPush instantiates a new InfoPush object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInfoPush(createdAt time.Time, data InfoPushData, hash string, id string, isEnabled bool, priority int32, releaseStatus ReleaseStatus, tags []string, updatedAt time.Time) *InfoPush {
	this := InfoPush{}
...
func (o *InfoPush) UnmarshalJSON(data []byte) (err error) {
