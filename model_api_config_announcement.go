...
type _APIConfigAnnouncement APIConfigAnnouncement
...
func (o *APIConfigAnnouncement) UnmarshalJSON(data []byte) (err error) {
	...
	*o = APIConfigAnnouncement(varAPIConfigAnnouncement)
