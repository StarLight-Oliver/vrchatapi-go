...
// checks if the NotificationV2DetailsBoop type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationV2DetailsBoop{}
...
func NewNotificationV2DetailsBoop(emojiId string, emojiVersion NullableInt32, inventoryItemId string) *NotificationV2DetailsBoop {
	this := NotificationV2DetailsBoop{}
...
// GetEmojiVersion returns the EmojiVersion field value
// If the value is explicit nil, the zero value for int32 will be returned
func (o *NotificationV2DetailsBoop) GetEmojiVersion() int32 {
	if o == nil || o.EmojiVersion.Get() == nil {
		var ret int32
		return ret
	}

	return *o.EmojiVersion.Get()
}

// GetEmojiVersionOk returns a tuple with the EmojiVersion field value
// and a boolean to check if the value has been set.
...
func (o *NotificationV2DetailsBoop) GetEmojiVersionOk() (*int32, bool) {
	...
	return o.EmojiVersion.Get(), o.EmojiVersion.IsSet()
}

// SetEmojiVersion sets field value
func (o *NotificationV2DetailsBoop) SetEmojiVersion(v int32) {
	o.EmojiVersion.Set(&v)
}
...
func (o NotificationV2DetailsBoop) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["emojiId"] = o.EmojiId
	toSerialize["emojiVersion"] = o.EmojiVersion.Get()
	toSerialize["inventoryItemId"] = o.InventoryItemId
	return toSerialize, nil
}

func (o *NotificationV2DetailsBoop) UnmarshalJSON(data []byte) (err error) {
	...
	*o = NotificationV2DetailsBoop(varNotificationV2DetailsBoop)

	return err
}

type NullableNotificationV2DetailsBoop struct {
	value *NotificationV2DetailsBoop
	isSet bool
}

func (v NullableNotificationV2DetailsBoop) Get() *NotificationV2DetailsBoop {
	return v.value
}

func (v *NullableNotificationV2DetailsBoop) Set(val *NotificationV2DetailsBoop) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationV2DetailsBoop) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationV2DetailsBoop) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationV2DetailsBoop(val *NotificationV2DetailsBoop) *NullableNotificationV2DetailsBoop {
	return &NullableNotificationV2DetailsBoop{value: val, isSet: true}
}

func (v NullableNotificationV2DetailsBoop) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationV2DetailsBoop) UnmarshalJSON(src []byte) error {
	v.isSet = true
