...
// checks if the InventoryConsumptionResults type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InventoryConsumptionResults{}
...
func NewInventoryConsumptionResults(errors []map[string]interface{}, inventoryItems []InventoryItem, inventoryItemsCreated int32) *InventoryConsumptionResults {
	this := InventoryConsumptionResults{}
	this.Errors = errors
...
// GetInventoryItems returns the InventoryItems field value
...
// GetInventoryItemsOk returns a tuple with the InventoryItems field value
// and a boolean to check if the value has been set.
...
// SetInventoryItems sets field value
func (o *InventoryConsumptionResults) SetInventoryItems(v []InventoryItem) {
	o.InventoryItems = v
}

// GetInventoryItemsCreated returns the InventoryItemsCreated field value
func (o *InventoryConsumptionResults) GetInventoryItemsCreated() int32 {
	...
	return o.InventoryItemsCreated
}

// GetInventoryItemsCreatedOk returns a tuple with the InventoryItemsCreated field value
// and a boolean to check if the value has been set.
func (o *InventoryConsumptionResults) GetInventoryItemsCreatedOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.InventoryItemsCreated, true
}

// SetInventoryItemsCreated sets field value
func (o *InventoryConsumptionResults) SetInventoryItemsCreated(v int32) {
	o.InventoryItemsCreated = v
}
...
func (o InventoryConsumptionResults) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["errors"] = o.Errors
	toSerialize["inventoryItems"] = o.InventoryItems
	toSerialize["inventoryItemsCreated"] = o.InventoryItemsCreated
	return toSerialize, nil
}

func (o *InventoryConsumptionResults) UnmarshalJSON(data []byte) (err error) {
	...
	*o = InventoryConsumptionResults(varInventoryConsumptionResults)

	return err
}

type NullableInventoryConsumptionResults struct {
	value *InventoryConsumptionResults
	isSet bool
}

func (v NullableInventoryConsumptionResults) Get() *InventoryConsumptionResults {
	return v.value
}

func (v *NullableInventoryConsumptionResults) Set(val *InventoryConsumptionResults) {
	v.value = val
	v.isSet = true
}

func (v NullableInventoryConsumptionResults) IsSet() bool {
	return v.isSet
}

func (v *NullableInventoryConsumptionResults) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInventoryConsumptionResults(val *InventoryConsumptionResults) *NullableInventoryConsumptionResults {
	return &NullableInventoryConsumptionResults{value: val, isSet: true}
}

func (v NullableInventoryConsumptionResults) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInventoryConsumptionResults) UnmarshalJSON(src []byte) error {
	v.isSet = true
