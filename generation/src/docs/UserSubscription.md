...
**Starts** | Pointer to **string** |  | [optional] 
...
GetIsBulkGift returns the IsBulkGift field if non-nil, zero value otherwise.

### GetIsBulkGiftOk

`func (o *UserSubscription) GetIsBulkGiftOk() (*bool, bool)`

GetIsBulkGiftOk returns a tuple with the IsBulkGift field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetIsBulkGift sets IsBulkGift field to given value.
