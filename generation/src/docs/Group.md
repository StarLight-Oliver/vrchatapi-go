...
------------ | ------------- | ------------- | -------------
**AgeVerificationBetaCode** | Pointer to **string** |  | [optional] 
**AgeVerificationBetaSlots** | Pointer to **float32** |  | [optional] 
**AgeVerificationSlotsAvailable** | Pointer to **bool** |  | [optional] 
**AllowGroupJoinPrompt** | Pointer to **bool** |  | [optional] 
...
### GetAgeVerificationBetaCode

`func (o *Group) GetAgeVerificationBetaCode() string`

GetAgeVerificationBetaCode returns the AgeVerificationBetaCode field if non-nil, zero value otherwise.

### GetAgeVerificationBetaCodeOk

`func (o *Group) GetAgeVerificationBetaCodeOk() (*string, bool)`

GetAgeVerificationBetaCodeOk returns a tuple with the AgeVerificationBetaCode field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAgeVerificationBetaCode

`func (o *Group) SetAgeVerificationBetaCode(v string)`

SetAgeVerificationBetaCode sets AgeVerificationBetaCode field to given value.

### HasAgeVerificationBetaCode

`func (o *Group) HasAgeVerificationBetaCode() bool`

HasAgeVerificationBetaCode returns a boolean if a field has been set.

### GetAgeVerificationBetaSlots

`func (o *Group) GetAgeVerificationBetaSlots() float32`

GetAgeVerificationBetaSlots returns the AgeVerificationBetaSlots field if non-nil, zero value otherwise.

### GetAgeVerificationBetaSlotsOk

`func (o *Group) GetAgeVerificationBetaSlotsOk() (*float32, bool)`

GetAgeVerificationBetaSlotsOk returns a tuple with the AgeVerificationBetaSlots field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAgeVerificationBetaSlots

`func (o *Group) SetAgeVerificationBetaSlots(v float32)`

SetAgeVerificationBetaSlots sets AgeVerificationBetaSlots field to given value.

### HasAgeVerificationBetaSlots

`func (o *Group) HasAgeVerificationBetaSlots() bool`

HasAgeVerificationBetaSlots returns a boolean if a field has been set.

### GetAgeVerificationSlotsAvailable

`func (o *Group) GetAgeVerificationSlotsAvailable() bool`

GetAgeVerificationSlotsAvailable returns the AgeVerificationSlotsAvailable field if non-nil, zero value otherwise.

### GetAgeVerificationSlotsAvailableOk

`func (o *Group) GetAgeVerificationSlotsAvailableOk() (*bool, bool)`

GetAgeVerificationSlotsAvailableOk returns a tuple with the AgeVerificationSlotsAvailable field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAgeVerificationSlotsAvailable

`func (o *Group) SetAgeVerificationSlotsAvailable(v bool)`

SetAgeVerificationSlotsAvailable sets AgeVerificationSlotsAvailable field to given value.

### HasAgeVerificationSlotsAvailable
...
### GetAllowGroupJoinPrompt

`func (o *Group) GetAllowGroupJoinPrompt() bool`

GetAllowGroupJoinPrompt returns the AllowGroupJoinPrompt field if non-nil, zero value otherwise.

### GetAllowGroupJoinPromptOk

`func (o *Group) GetAllowGroupJoinPromptOk() (*bool, bool)`

GetAllowGroupJoinPromptOk returns a tuple with the AllowGroupJoinPrompt field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAllowGroupJoinPrompt

`func (o *Group) SetAllowGroupJoinPrompt(v bool)`

SetAllowGroupJoinPrompt sets AllowGroupJoinPrompt field to given value.

### HasAllowGroupJoinPrompt
...
`func (o *Group) SetLastPostCreatedAtNil(b bool)`
