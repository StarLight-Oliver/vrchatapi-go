...
------------ | ------------- | ------------- | -------------
**AcceptedByDisplayName** | Pointer to **NullableString** |  | [optional] 
**AcceptedById** | Pointer to **NullableString** |  | [optional] 
...
### GetAcceptedByDisplayName

`func (o *GroupMember) GetAcceptedByDisplayName() string`

GetAcceptedByDisplayName returns the AcceptedByDisplayName field if non-nil, zero value otherwise.

### GetAcceptedByDisplayNameOk

`func (o *GroupMember) GetAcceptedByDisplayNameOk() (*string, bool)`

GetAcceptedByDisplayNameOk returns a tuple with the AcceptedByDisplayName field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAcceptedByDisplayName

`func (o *GroupMember) SetAcceptedByDisplayName(v string)`

SetAcceptedByDisplayName sets AcceptedByDisplayName field to given value.

### HasAcceptedByDisplayName

`func (o *GroupMember) HasAcceptedByDisplayName() bool`

HasAcceptedByDisplayName returns a boolean if a field has been set.

### SetAcceptedByDisplayNameNil

`func (o *GroupMember) SetAcceptedByDisplayNameNil(b bool)`

 SetAcceptedByDisplayNameNil sets the value for AcceptedByDisplayName to be an explicit nil

### UnsetAcceptedByDisplayName
`func (o *GroupMember) UnsetAcceptedByDisplayName()`

UnsetAcceptedByDisplayName ensures that no value is present for AcceptedByDisplayName, not even an explicit nil
### GetAcceptedById

`func (o *GroupMember) GetAcceptedById() string`

GetAcceptedById returns the AcceptedById field if non-nil, zero value otherwise.

### GetAcceptedByIdOk

`func (o *GroupMember) GetAcceptedByIdOk() (*string, bool)`

GetAcceptedByIdOk returns a tuple with the AcceptedById field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetAcceptedById

`func (o *GroupMember) SetAcceptedById(v string)`

SetAcceptedById sets AcceptedById field to given value.

### HasAcceptedById

`func (o *GroupMember) HasAcceptedById() bool`

HasAcceptedById returns a boolean if a field has been set.

### SetAcceptedByIdNil

`func (o *GroupMember) SetAcceptedByIdNil(b bool)`

 SetAcceptedByIdNil sets the value for AcceptedById to be an explicit nil

### UnsetAcceptedById
`func (o *GroupMember) UnsetAcceptedById()`
...
`func (o *GroupMember) GetHasJoinedFromPurchase() bool`
...
`func (o *GroupMember) GetHasJoinedFromPurchaseOk() (*bool, bool)`
...
`func (o *GroupMember) SetHasJoinedFromPurchase(v bool)`

SetHasJoinedFromPurchase sets HasJoinedFromPurchase field to given value.

### HasHasJoinedFromPurchase

`func (o *GroupMember) HasHasJoinedFromPurchase() bool`
...
`func (o *GroupMember) GetIsSubscribedToEventAnnouncements() bool`
...
`func (o *GroupMember) GetIsSubscribedToEventAnnouncementsOk() (*bool, bool)`
...
`func (o *GroupMember) SetIsSubscribedToEventAnnouncements(v bool)`
...
`func (o *GroupMember) HasIsSubscribedToEventAnnouncements() bool`
...
`func (o *GroupMember) SetMRoleIds(v []string)`

SetMRoleIds sets MRoleIds field to given value.

### HasMRoleIds

`func (o *GroupMember) HasMRoleIds() bool`
...
`func (o *GroupMember) GetMembershipStatus() GroupMemberStatus`

GetMembershipStatus returns the MembershipStatus field if non-nil, zero value otherwise.

### GetMembershipStatusOk

`func (o *GroupMember) GetMembershipStatusOk() (*GroupMemberStatus, bool)`
...
`func (o *GroupMember) SetMembershipStatus(v GroupMemberStatus)`
