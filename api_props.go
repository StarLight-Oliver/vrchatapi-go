...
func (r ApiCreatePropRequest) CreatePropRequest(createPropRequest CreatePropRequest) ApiCreatePropRequest {
	r.createPropRequest = &createPropRequest
	return r
}

func (r ApiCreatePropRequest) Execute() (*Prop, *http.Response, error) {
	return r.ApiService.CreatePropExecute(r)
}
...
func (a *PropsAPIService) CreatePropExecute(r ApiCreatePropRequest) (*Prop, *http.Response, error) {
	...
	localVarPath := localBasePath + "/props"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.createPropRequest == nil {
		return localVarReturnValue, nil, reportError("createPropRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.createPropRequest
...
func (r ApiDeletePropRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeletePropExecute(r)
}
...
func (r ApiGetPropRequest) Execute() (*Prop, *http.Response, error) {
	return r.ApiService.GetPropExecute(r)
}
...
func (r ApiGetPropPublishStatusRequest) Execute() (*PropPublishStatus, *http.Response, error) {
	return r.ApiService.GetPropPublishStatusExecute(r)
}

/*
GetPropPublishStatus Get Prop Publish Status
...
func (r ApiListPropsRequest) AuthorId(authorId string) ApiListPropsRequest {
	r.authorId = &authorId
	return r
}

// The number of objects to return.
func (r ApiListPropsRequest) N(n int32) ApiListPropsRequest {
	r.n = &n
	return r
}

// A zero-based offset from the default object sorting from where search results start.
func (r ApiListPropsRequest) Offset(offset int32) ApiListPropsRequest {
	r.offset = &offset
	return r
}

func (r ApiListPropsRequest) Execute() ([]Prop, *http.Response, error) {
	return r.ApiService.ListPropsExecute(r)
}

/*
ListProps List Props
...
func (r ApiPublishPropRequest) Execute() (*PropPublishStatus, *http.Response, error) {
	return r.ApiService.PublishPropExecute(r)
}

/*
PublishProp Publish Prop
...
func (r ApiUnpublishPropRequest) Execute() (*PropPublishStatus, *http.Response, error) {
	return r.ApiService.UnpublishPropExecute(r)
}

/*
UnpublishProp Unpublish Prop
...
func (r ApiUpdatePropRequest) UpdatePropRequest(updatePropRequest UpdatePropRequest) ApiUpdatePropRequest {
	r.updatePropRequest = &updatePropRequest
	return r
}

func (r ApiUpdatePropRequest) Execute() (*Prop, *http.Response, error) {
	return r.ApiService.UpdatePropExecute(r)
}
...
func (a *PropsAPIService) UpdatePropExecute(r ApiUpdatePropRequest) (*Prop, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updatePropRequest == nil {
		return localVarReturnValue, nil, reportError("updatePropRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updatePropRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
