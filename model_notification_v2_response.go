...
// checks if the NotificationV2Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotificationV2Response{}
...
// GetTextKey returns the TextKey field value
// If the value is explicit nil, the zero value for string will be returned
func (o *NotificationV2Response) GetTextKey() string {
	if o == nil || o.TextKey.Get() == nil {
		var ret string
		return ret
	}

	return *o.TextKey.Get()
}

// GetTextKeyOk returns a tuple with the TextKey field value
// and a boolean to check if the value has been set.
...
func (o *NotificationV2Response) GetTextKeyOk() (*string, bool) {
	...
	return o.TextKey.Get(), o.TextKey.IsSet()
}

// SetTextKey sets field value
...
func (o NotificationV2Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["data"] = o.Data
	toSerialize["icon"] = o.Icon
	toSerialize["text"] = o.Text
	toSerialize["textKey"] = o.TextKey.Get()
	toSerialize["type"] = o.Type
	return toSerialize, nil
}

func (o *NotificationV2Response) UnmarshalJSON(data []byte) (err error) {
	...
	*o = NotificationV2Response(varNotificationV2Response)

	return err
}

type NullableNotificationV2Response struct {
	value *NotificationV2Response
	isSet bool
}

func (v NullableNotificationV2Response) Get() *NotificationV2Response {
	return v.value
}

func (v *NullableNotificationV2Response) Set(val *NotificationV2Response) {
	v.value = val
	v.isSet = true
}

func (v NullableNotificationV2Response) IsSet() bool {
	return v.isSet
}

func (v *NullableNotificationV2Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotificationV2Response(val *NotificationV2Response) *NullableNotificationV2Response {
	return &NullableNotificationV2Response{value: val, isSet: true}
}

func (v NullableNotificationV2Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotificationV2Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
