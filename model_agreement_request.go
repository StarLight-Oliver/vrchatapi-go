...
// checks if the AgreementRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgreementRequest{}

// AgreementRequest struct for AgreementRequest
type AgreementRequest struct {
	...
	AgreementFulltext string `json:"agreementFulltext"`
...
type _AgreementRequest AgreementRequest
...
// GetAgreementFulltext returns the AgreementFulltext field value
...
// GetAgreementFulltextOk returns a tuple with the AgreementFulltext field value
// and a boolean to check if the value has been set.
...
// SetAgreementFulltext sets field value
...
func (o AgreementRequest) MarshalJSON() ([]byte, error) {
...
func (o AgreementRequest) ToMap() (map[string]interface{}, error) {
...
func (o *AgreementRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varAgreementRequest := _AgreementRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAgreementRequest)

	if err != nil {
		return err
	}

	*o = AgreementRequest(varAgreementRequest)

	return err
}

type NullableAgreementRequest struct {
	value *AgreementRequest
	isSet bool
}

func (v NullableAgreementRequest) Get() *AgreementRequest {
	return v.value
}

func (v *NullableAgreementRequest) Set(val *AgreementRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAgreementRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAgreementRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgreementRequest(val *AgreementRequest) *NullableAgreementRequest {
	return &NullableAgreementRequest{value: val, isSet: true}
}

func (v NullableAgreementRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgreementRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
