...
func (r ApiCloseInstanceRequest) HardClose(hardClose bool) ApiCloseInstanceRequest {
	r.hardClose = &hardClose
	return r
}

// The time after which users won&#39;t be allowed to join the instances. If omitted, the instance will be closed immediately.
func (r ApiCloseInstanceRequest) ClosedAt(closedAt time.Time) ApiCloseInstanceRequest {
	r.closedAt = &closedAt
	return r
}

func (r ApiCloseInstanceRequest) Execute() (*Instance, *http.Response, error) {
	return r.ApiService.CloseInstanceExecute(r)
}

/*
CloseInstance Close Instance
...
func (a *InstancesAPIService) CloseInstanceExecute(r ApiCloseInstanceRequest) (*Instance, *http.Response, error) {
	...
	if r.hardClose != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "hardClose", r.hardClose, "form", "")
	}
	if r.closedAt != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "closedAt", r.closedAt, "form", "")
	}
...
func (r ApiGetRecentLocationsRequest) N(n int32) ApiGetRecentLocationsRequest {
	r.n = &n
	return r
}

// A zero-based offset from the default object sorting from where search results start.
func (r ApiGetRecentLocationsRequest) Offset(offset int32) ApiGetRecentLocationsRequest {
	r.offset = &offset
	return r
}

func (r ApiGetRecentLocationsRequest) Execute() ([]string, *http.Response, error) {
	return r.ApiService.GetRecentLocationsExecute(r)
}

/*
GetRecentLocations List Recent Locations
...
func (a *InstancesAPIService) GetRecentLocationsExecute(r ApiGetRecentLocationsRequest) ([]string, *http.Response, error) {
	...
	localVarPath := localBasePath + "/instances/recent"
