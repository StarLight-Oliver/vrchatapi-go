...
// checks if the AgreementStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgreementStatus{}
...
type _AgreementStatus AgreementStatus
...
func (o AgreementStatus) ToMap() (map[string]interface{}, error) {
...
func (o *AgreementStatus) UnmarshalJSON(data []byte) (err error) {
	...
	*o = AgreementStatus(varAgreementStatus)
