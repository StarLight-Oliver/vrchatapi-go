...
func NewAdminUnityPackageWithDefaults() *AdminUnityPackage {
	this := AdminUnityPackage{}
	var unityVersion string = "2022.3.22f1-DWR"
	this.UnityVersion = unityVersion
	return &this
}
...
func (o AdminUnityPackage) ToMap() (map[string]interface{}, error) {
...
func (o *AdminUnityPackage) UnmarshalJSON(data []byte) (err error) {
	...
	*o = AdminUnityPackage(varAdminUnityPackage)

	return err
}

type NullableAdminUnityPackage struct {
	value *AdminUnityPackage
	isSet bool
}

func (v NullableAdminUnityPackage) Get() *AdminUnityPackage {
	return v.value
}

func (v *NullableAdminUnityPackage) Set(val *AdminUnityPackage) {
	v.value = val
	v.isSet = true
}

func (v NullableAdminUnityPackage) IsSet() bool {
	return v.isSet
}

func (v *NullableAdminUnityPackage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdminUnityPackage(val *AdminUnityPackage) *NullableAdminUnityPackage {
	return &NullableAdminUnityPackage{value: val, isSet: true}
}

func (v NullableAdminUnityPackage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdminUnityPackage) UnmarshalJSON(src []byte) error {
	v.isSet = true
