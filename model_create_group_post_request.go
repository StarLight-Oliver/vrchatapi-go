...
// checks if the CreateGroupPostRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateGroupPostRequest{}
...
type _CreateGroupPostRequest CreateGroupPostRequest
...
// GetSendNotification returns the SendNotification field value
...
// GetSendNotificationOk returns a tuple with the SendNotification field value
// and a boolean to check if the value has been set.
...
// SetSendNotification sets field value
...
func (o CreateGroupPostRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CreateGroupPostRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CreateGroupPostRequest(varCreateGroupPostRequest)

	return err
}

type NullableCreateGroupPostRequest struct {
	value *CreateGroupPostRequest
	isSet bool
}

func (v NullableCreateGroupPostRequest) Get() *CreateGroupPostRequest {
	return v.value
}

func (v *NullableCreateGroupPostRequest) Set(val *CreateGroupPostRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateGroupPostRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateGroupPostRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateGroupPostRequest(val *CreateGroupPostRequest) *NullableCreateGroupPostRequest {
	return &NullableCreateGroupPostRequest{value: val, isSet: true}
}

func (v NullableCreateGroupPostRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateGroupPostRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
