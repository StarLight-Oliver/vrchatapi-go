...
// checks if the CalendarEventDiscovery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CalendarEventDiscovery{}
...
func (o CalendarEventDiscovery) ToMap() (map[string]interface{}, error) {
...
func (o *CalendarEventDiscovery) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CalendarEventDiscovery(varCalendarEventDiscovery)

	return err
}

type NullableCalendarEventDiscovery struct {
	value *CalendarEventDiscovery
	isSet bool
}

func (v NullableCalendarEventDiscovery) Get() *CalendarEventDiscovery {
	return v.value
}

func (v *NullableCalendarEventDiscovery) Set(val *CalendarEventDiscovery) {
	v.value = val
	v.isSet = true
}

func (v NullableCalendarEventDiscovery) IsSet() bool {
	return v.isSet
}

func (v *NullableCalendarEventDiscovery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCalendarEventDiscovery(val *CalendarEventDiscovery) *NullableCalendarEventDiscovery {
	return &NullableCalendarEventDiscovery{value: val, isSet: true}
}

func (v NullableCalendarEventDiscovery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCalendarEventDiscovery) UnmarshalJSON(src []byte) error {
	v.isSet = true
