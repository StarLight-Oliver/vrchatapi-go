...
type _VerifyAuthTokenResult VerifyAuthTokenResult
...
func (o *VerifyAuthTokenResult) UnmarshalJSON(data []byte) (err error) {
	...
	varVerifyAuthTokenResult := _VerifyAuthTokenResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVerifyAuthTokenResult)

	if err != nil {
		return err
	}

	*o = VerifyAuthTokenResult(varVerifyAuthTokenResult)
